...
import SensitivityTime from "./SensitivityTime";
...
const SensitivitySKOmus:FC<Props> = ({y, x,textY, textX, typeChart}) => {
...
export default SensitivitySKOmus;
